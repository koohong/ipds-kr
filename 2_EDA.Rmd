...
p4<- ggplot(gapminder, aes(lifeExp)) + geom_histogram()
...
p1<- mpg %>% ggplot(aes(class, hwy)) + geom_boxplot()+ coord_flip()

p2<- mpg %>% ggplot(aes(class, hwy)) + geom_jitter(col='gray') +
  geom_boxplot(alpha=.5)+ coord_flip()

p3 <- mpg %>% mutate(class=reorder(class, hwy, median)) %>%
